      ...
      <Container>
        ...
        <div className="max-w-5xl">
          ...
          <h1 className="text-5xl font-bold leading-tight tracking-tight text-white md:text-8xl">
            Building enterprise solutions with modern development practices.
          </h1>

          {/* Description */}
          <p className="mt-8 max-w-2xl text-lg leading-8 text-slate-400">
            Specialized in Microsoft Power Platform, automation workflows,
            scalable business solutions and modern frontend experiences.
          </p>
